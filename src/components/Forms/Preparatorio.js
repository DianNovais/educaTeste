    ...
    <div className='form_Container'>
        ...
        <label className="estado_container">
          ...
          <datalist id="cursosList">
            <option defaultValue="POLICIAS">POLICIAS</option>
            <option defaultValue="INSS">INSS</option>
            <option defaultValue="NIVEL MEDIO">NÍVEL MÉDIO</option>
          </datalist>
        </label>
